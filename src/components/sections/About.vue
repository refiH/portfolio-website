<template>
  <section id="about" class="overflow-hidden xl:h-[690px] h-full">
    ...
    >
      <div
        class="bg-secondary py-4 text-center md:col-span-3 sm:col-span-5 col-span-8 grid place-items-center"
      >
        <h2 class="md:text-h2 text-h3">ABOUT ME</h2>
      </div>
      ...
      <div
        ...
        class="resume group border-[4px] border-secondary md:col-start-7 col-start-1 md:col-end-9 sm:col-end-5 col-end-9 md:row-start-3 row-start-4 overflow-hidden flex items-center justify-center cursor-pointer hover:bg-secondary"
      >
        <h1
