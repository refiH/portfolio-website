<template>
  <section id="projects" class="xl:min-h-[690px] px-0 my-24">
    <div class="flex flex-col justify-between sm:py-8 max-w-none">
        ...
        >
          ...
          <div class="flex-1 flex flex-col sm:flex-row gap-8 md:mx-12 sm:mx-8 mx-6">
            <div class="sm:flex-1 flex flex-col gap-4">
              ...
              />
              <div class="h-[6rem] text-h6 bg-primary"></div>
            </div>
      ...
      <div class="relative">
        <div class="swiper z-[1] w-full !static section-max">
          <div class="swiper-wrapper mb-12">
            ...
            >
              ...
              >
                ...
                <h6
                  class="text-h6 font-bold px-3 py-1 absolute -top-4 left-0 bg-primary select-none"
                >
                  {{ val.tag }}
                </h6>
              </div>
